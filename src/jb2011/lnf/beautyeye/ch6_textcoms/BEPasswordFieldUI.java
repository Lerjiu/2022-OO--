...
package jb2011.lnf.beautyeye.ch6_textcoms;
...
import jb2011.lnf.beautyeye.ch6_textcoms.BETextFieldUI;
import jb2011.lnf.beautyeye.ch6_textcoms.__Icon9Factory__;
import jb2011.lnf.beautyeye.ch6_textcoms.__UI__.BgSwitchable;
import jb2011.lnf.beautyeye.widget.FocusListenerImpl;
...
public class BEPasswordFieldUI extends BasicPasswordFieldUI implements BgSwitchable
	,jb2011.lnf.beautyeye.BeautyEyeLNFHelper.__UseParentPaintSurported//WindowsPasswordFieldUI
{
	
	/** The bg. */
	private NinePatch bg = jb2011.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance().getTextFieldBgNormal();
...
//    	c.addMouseListener(new NLLookAndFeel.EditMenu());
    ...
    /* (non-Javadoc)
     * @see jb2011.lnf.beautyeye.ch6_textcoms.__UI__.BgSwitchable#switchBgToNomal()
     */
    public void switchBgToNomal()
    {
    	this.bg = jb2011.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance().getTextFieldBgNormal();
    }
    
    /* (non-Javadoc)
     * @see jb2011.lnf.beautyeye.ch6_textcoms.__UI__.BgSwitchable#switchBgToFocused()
     */

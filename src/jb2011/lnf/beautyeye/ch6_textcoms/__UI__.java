...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		UIManager.put("TextFieldUI",jb2011.lnf.beautyeye.ch6_textcoms.BETextFieldUI.class.getName());
		...
		UIManager.put("FormattedTextFieldUI",jb2011.lnf.beautyeye.ch6_textcoms.BEFormattedTextFieldUI.class.getName());
		...
		UIManager.put("PasswordFieldUI",jb2011.lnf.beautyeye.ch6_textcoms.BEPasswordFieldUI.class.getName());
		...
		UIManager.put("TextAreaUI",jb2011.lnf.beautyeye.ch6_textcoms.BETextAreaUI.class.getName());
...
//		UIManager.put("TextPane.margin",new InsetsUIResource(3,3,3,3));
		...
		UIManager.put("TextPaneUI",jb2011.lnf.beautyeye.ch6_textcoms.BETextPaneUI.class.getName());
...
//		UIManager.put("EditorPane.margin",new InsetsUIResource(3,3,3,3));
		...
		UIManager.put("EditorPaneUI",jb2011.lnf.beautyeye.ch6_textcoms.BEEditorPaneUI.class.getName());
	}

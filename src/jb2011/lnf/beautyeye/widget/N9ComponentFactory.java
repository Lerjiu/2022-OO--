 ...
 */
package jb2011.lnf.beautyeye.widget;
...
import jb2011.lnf.beautyeye.widget.ImageBgPanel;
import jb2011.lnf.beautyeye.widget.__Icon9Factory__;
import jb2011.ninepatch4j.NinePatch;
...
public class N9ComponentFactory extends JLabel
{
	...
	{
		return createLabel_root(txt, jb2011.lnf.beautyeye.widget.__Icon9Factory__.getInstance().getHintBgLightBlue()
	...
	{
		return createLabel_root(txt, jb2011.lnf.beautyeye.widget.__Icon9Factory__.getInstance().getTipsBg()
	...
	{
		return createLabel_root(txt, jb2011.lnf.beautyeye.widget.__Icon9Factory__.getInstance().getOrangeBaloon()
	...
	{
		return createLabel_root(txt, jb2011.lnf.beautyeye.widget.__Icon9Factory__.getInstance().getHintBgLightGray()
	 ...
	 */
	public static jb2011.lnf.beautyeye.widget.ImageBgPanel createPanel_style1()
	{
	 ...
	 * @return the image bg panel
	 */
	public static jb2011.lnf.beautyeye.widget.ImageBgPanel createPanel_style1(Insets is)
	{
		jb2011.lnf.beautyeye.widget.ImageBgPanel p = new ImageBgPanel().setN9(__Icon9Factory__.getInstance().getPanelBg());
		if(is != null)

 ...
 */
package jb2011.lnf.beautyeye.widget.border;

import jb2011.lnf.beautyeye.widget.border.NinePatchBorder;
 ...
 * @see jb2011.lnf.beautyeye.BeautyEyeLNFHelper.FrameBorderStyle#translucencySmallShadow
 */
public class BEShadowBorder extends NinePatchBorder//AbstractBorder
{
	...
	public BEShadowBorder()
	{
		super(new Insets(TOP, LEFT, BOTTOM, RIGHT)
				, jb2011.lnf.beautyeye.widget.__Icon9Factory__.getInstance().getBorderIcon_Shadow1());
	}

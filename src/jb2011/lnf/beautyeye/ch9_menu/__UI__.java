 ...
 */
package jb2011.lnf.beautyeye.ch9_menu;
...
//		UIManager.put("MenuBar.border",new jb2011.lnf.windows2.ch10.EWindowsMenuBarUI.MenuBarBorder(Color.red,Color.BLUE));
...
//		UIManager.put("PopupMenu.border",new BorderUIResource(BorderFactory.createEmptyBorder(20,10,20,10)));//	
		...
		UIManager.put("CheckBoxMenuItem.checkIcon",new jb2011.lnf.beautyeye.ch9_menu.BECheckBoxMenuItemUI.CheckBoxMenuItemIcon());//javax.swing.plaf.basic.BasicIconFactory.CheckBoxMenuItemIcon);
		//单选按钮式的菜单项选中与否的图标实现设定
		UIManager.put("RadioButtonMenuItem.checkIcon",new jb2011.lnf.beautyeye.ch9_menu.BERadioButtonMenuItemUI.RadioButtonMenuItemIcon());
		...
		//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> UI实现类设置 START
		UIManager.put("MenuBarUI",jb2011.lnf.beautyeye.ch9_menu.BEMenuBarUI.class.getName());
		UIManager.put("MenuUI",jb2011.lnf.beautyeye.ch9_menu.BEMenuUI.class.getName());
		UIManager.put("MenuItemUI",jb2011.lnf.beautyeye.ch9_menu.BEMenuItemUI.class.getName());
		UIManager.put("RadioButtonMenuItemUI",jb2011.lnf.beautyeye.ch9_menu.BERadioButtonMenuItemUI.class.getName());
		UIManager.put("CheckBoxMenuItemUI",jb2011.lnf.beautyeye.ch9_menu.BECheckBoxMenuItemUI.class.getName());
		UIManager.put("PopupMenuSeparatorUI",jb2011.lnf.beautyeye.ch9_menu.BEPopupMenuSeparatorUI.class.getName());
		UIManager.put("PopupMenuUI",jb2011.lnf.beautyeye.ch9_menu.BEPopupMenuUI.class.getName());
		//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> UI实现类设置 END
	}
}

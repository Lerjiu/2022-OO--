 ...
 */
package jb2011.lnf.beautyeye.ch19_list;
...
import jb2011.lnf.beautyeye.ch19_list.MyDefaultListCellRenderer;
...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		UIManager.put("List.border",new BorderUIResource(BorderFactory.createEmptyBorder(5,5,5,5)));
		...
		UIManager.put("List.focusSelectedCellHighlightBorder"
				,new BorderUIResource(new jb2011.lnf.beautyeye.ch19_list.__UI__.FocusSelectedCellHighlightBorder()));
...
//		background-image: linear-gradient(to right, #ffecd2 0%, #fcb69f 100%);
		...
		UIManager.put("ListUI", jb2011.lnf.beautyeye.ch19_list.BEListUI.class.getName());
	}

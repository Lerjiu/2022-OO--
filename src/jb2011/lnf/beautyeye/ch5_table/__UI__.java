 ...
 */
package jb2011.lnf.beautyeye.ch5_table;
...
import jb2011.lnf.beautyeye.ch_x.__IconFactory__;
...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		UIManager.put("Table.scrollPaneBorder",new BorderUIResource(new jb2011.lnf.beautyeye.ch5_table.TableScrollBorder()));//defaut is com.sun.java.swing.plaf.windows.XPStyle.XPFillBorder
		UIManager.put("Table.focusCellHighlightBorder",new BorderUIResource(new jb2011.lnf.beautyeye.ch5_table.FocusCellHighlightBorder()));//new BEDashedBorder(new Color(0,160,0),1,0,true,false,true,false)));
		...
		UIManager.put("TableUI",jb2011.lnf.beautyeye.ch5_table.BETableUI.class.getName());
...
//		UIManager.put("TableHeader.font",new Font("宋体",Font.PLAIN,12));//此属性将决定表头的字体
		...
		if(JVM.current().isOrLater(JVM.JDK1_6))
		{
			...
			UIManager.put("TableHeaderUI","jb2011.lnf.beautyeye.ch5_table.BETableHeaderUI");
...
//					new SwingLazyValue("javax.swing.plaf.metal.MetalBorders$TableHeaderBorder")
					new BorderUIResource(new jb2011.lnf.beautyeye.ch5_table.__UI__.TableHeaderBorder())
			);
...
//			g.drawLine( 0, 0, 0, h-2 );
			...
			//绘制表头单元的右分隔竖线
			jb2011.lnf.beautyeye.ch5_table.__Icon9Factory__.getInstance().getTableHeaderCellSeparator1()

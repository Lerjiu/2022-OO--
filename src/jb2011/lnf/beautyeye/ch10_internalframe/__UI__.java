 ...
 */
package jb2011.lnf.beautyeye.ch10_internalframe;
...
import jb2011.lnf.beautyeye.ch10_internalframe.__IconFactory__;
...
//				,jb2011.lnf.windows2.ch1.__IconFactory__.getInstance().getInternalFrameCloseIcon());
		...
		UIManager.put("InternalFrameUI",jb2011.lnf.beautyeye.ch10_internalframe.BEInternalFrameUI.class.getName());
...
//		UIManager.put("Desktop.minOnScreenInsets",new InsetsUIResource(10,10,10,10));//default is 3,3,3,3
		...
		UIManager.put("DesktopIconUI",jb2011.lnf.beautyeye.ch10_internalframe.BEDesktopIconUI.class.getName());
	}
}

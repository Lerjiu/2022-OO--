 ...
 */
package jb2011.lnf.beautyeye.ch7_popup;
...
import jb2011.lnf.beautyeye.ch7_popup.__Icon9Factory__;
import jb2011.lnf.beautyeye.utils.WindowTranslucencyHelper;
...
//				}
				...
				ImageBgPanel imageContentPane = new ImageBgPanel().setN9(
						isTooltip?
								jb2011.lnf.beautyeye.ch7_popup.__Icon9Factory__.getInstance().getTooltipBg()
								:isComboBoxPopup?//是下拉框列表则使一个跟JScrollPane一样的背景图，好看！
										jb2011.lnf.beautyeye.ch4_scroll.__Icon9Factory__.getInstance().getScrollPaneBorderBg()

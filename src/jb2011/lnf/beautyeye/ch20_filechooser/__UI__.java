 ...
 */
package jb2011.lnf.beautyeye.ch20_filechooser;
...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		UIManager.put("FileChooser.listViewBorder"
				, new BorderUIResource(new jb2011.lnf.beautyeye.ch4_scroll.ScrollPaneBorder()));//com.sun.java.swing.plaf.windows.XPStyle.XPFillBorder);
	...
	public static void uiImpl_win()
	{
		...
		UIManager.put("FileChooserUI"
				,jb2011.lnf.beautyeye.ch20_filechooser.BEFileChooserUIWin.class.getName());
	}
	...
	{
		UIManager.put("FileChooserUI"
				,jb2011.lnf.beautyeye.ch20_filechooser.BEFileChooserUICross.class.getName());
	}
}

 ...
 */
package jb2011.lnf.beautyeye.ch18_spinner;
...
import jb2011.lnf.beautyeye.ch18_spinner.BESpinnerUI.GlyphButton.Type;
import jb2011.lnf.beautyeye.ch18_spinner.__Icon9Factory__;
...
//		if (NLXPStyle.getXP() != null) 
		{
			JButton xpButton = new GlyphButton(spinner, GlyphButton.Type.down);
...
//		if (NLXPStyle.getXP() != null) 
		{
			JButton xpButton = new GlyphButton(spinner, GlyphButton.Type.up);
			Dimension size = UIManager.getDimension("Spinner.arrowButtonSize");
			xpButton.setPreferredSize(size);
			xpButton.setRequestFocusEnabled(false);

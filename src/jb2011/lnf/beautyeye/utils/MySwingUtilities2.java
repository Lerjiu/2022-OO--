...
//       }
   ...
   {
	   return jb2011.lnf.beautyeye.utils.ReflectHelper.invokeStaticMethod(ReflectHelper.getClass(getSwingUtilities2ClassName())
   ...
   public static String getSwingUtilities2ClassName()
   {
	   ...
	   if(jb2011.lnf.beautyeye.utils.JVM.current().isOrLater(JVM.JDK1_6))

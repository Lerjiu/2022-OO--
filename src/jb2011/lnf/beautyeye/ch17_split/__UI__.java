 ...
 */
package jb2011.lnf.beautyeye.ch17_split;

import jb2011.lnf.beautyeye.ch17_split.SplitPaneDividerBorder;
...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		//JSplitePane的边框实现
		UIManager.put("SplitPane.border",new BorderUIResource(new jb2011.lnf.beautyeye.ch4_scroll.ScrollPaneBorder()));//BorderFactory.createEmptyBorder(0, 0, 0, 0)));
		UIManager.put("SplitPaneUI",jb2011.lnf.beautyeye.ch17_split.BESplitPaneUI.class.getName());

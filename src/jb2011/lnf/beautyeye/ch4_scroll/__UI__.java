 ...
 */
package jb2011.lnf.beautyeye.ch4_scroll;
...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> JScrollPane的相关ui值设定
		UIManager.put("ScrollPane.border",new BorderUIResource(new jb2011.lnf.beautyeye.ch4_scroll.ScrollPaneBorder()));//BorderFactory.createEmptyBorder(0, 0, 0, 0)));
		...
		UIManager.put("ScrollPaneUI",jb2011.lnf.beautyeye.ch4_scroll.BEScrollPaneUI.class.getName());
		...
		UIManager.put("ScrollBarUI",jb2011.lnf.beautyeye.ch4_scroll.BEScrollBarUI.class.getName());

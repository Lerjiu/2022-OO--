 ...
 */
package jb2011.lnf.beautyeye.ch8_toolbar;
...
//				com.sun.java.swing.plaf.windows.WindowsBorders.getToolBarBorder()));
				new jb2011.lnf.beautyeye.ch8_toolbar.BEToolBarUI.ToolBarBorder(UIManager.getColor("ToolBar.shadow"),
...
//				BorderFactory.createEmptyBorder(5, 0, 8, 0)));//5, 5, 8, 5)));
		...
		UIManager.put("ToolBarSeparatorUI"
				, jb2011.lnf.beautyeye.ch8_toolbar.BEToolBarSeparatorUI.class.getName());
		UIManager.put("ToolBarUI",jb2011.lnf.beautyeye.ch8_toolbar.BEToolBarUI.class.getName());
	}
}

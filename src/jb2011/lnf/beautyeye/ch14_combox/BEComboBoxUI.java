...
import jb2011.lnf.beautyeye.ch14_combox.BEComboBoxRenderer;
import jb2011.lnf.beautyeye.ch14_combox.__Icon9Factory__;
...
public class BEComboBoxUI extends BasicComboBoxUI 
	implements jb2011.lnf.beautyeye.BeautyEyeLNFHelper.__UseParentPaintSurported
{
    /**
     * Creates the ui.
     *
    ...
    public void paintCurrentValueBackground(Graphics g,Rectangle bounds,boolean hasFocus) 
    {
    	...
    	if(!isUseParentPaint())
    	{
    		if ( comboBox.isEnabled() )
    			jb2011.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance().getTextFieldBgNormal()
    			.draw((Graphics2D)g, 0,0,comboBox.getWidth(),comboBox.getHeight());
    		else
    			jb2011.lnf.beautyeye.ch6_textcoms.__Icon9Factory__.getInstance().getTextFieldBgDisabled()
    			.draw((Graphics2D)g, 0,0,comboBox.getWidth(),comboBox.getHeight());
    	}
    	else
    	{
